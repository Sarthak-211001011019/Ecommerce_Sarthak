...
<!-- Mirrored from freshcart.codescandy.com/pages/account-address.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 14 Nov 2024 06:08:47 GMT -->
<head>
      <!-- Required meta tags -->
      <meta charset="utf-8" />
      <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no" />
      <meta content="Codescandy" name="author" />
      <title>Account Address eCommerce HTML Template - FreshCart</title>
      <!-- Favicon icon-->
...
@if(isset($allData))
      <!-- SSSSSSSSSSSSSSSSSSSSSSSSSSSS ADDRESS SECTION SSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSS --> 
                  ...
                  @php
                  $primaryAddress = $allData->address;
                  $secAddresses = $allData->allAddresses;
                  $addArr = explode(":", $secAddresses);
                  @endphp
                              ...
                              <div class="card">
                                 <div class="card-body p-6">
                                    <div class="form-check mb-4">
                                       ...
                                       <label class="form-check-label text-dark fw-semibold" for="homeRadio">Primary Address</label>
                                    </div>
                                    <!-- address -->
                                    <p class="mb-6">
                                       {{$allData->name}}
                                    ...
                                    <div class="mt-4 primayAdrsEditForm">
                                       <form method="post" 
                                       action="{{url('/primeAddressUpdate')}}">
                                       @csrf
                                            <input type="hidden" name="editPrimeAddId" value="{{$allData->user_id}}">
                                            <input type="text" name="primeAddress" value="{{$allData->address}}"><br><br>
                                            <button class="btn btn-primary">update</button>
                                        </form>
                                    </div>
                                    <div class="mt-4">
                                       <button class="btn btn-outline-success primaryaddEditBtn">Edit</button>
                              ...
                              <div class="card">
                                 <div class="card-body p-6">
                                    <div class="form-check mb-4">
                                       ...
                                       <label class="form-check-label text-dark fw-semibold" for="officeRadio">Address @php echo $i;$i++; @endphp </label>
                                    </div>
                                    <!-- nav item -->
                                    <p class="mb-6">
                                       {{$allData->name}}
                                    ...
                                    <!-- link -->
                                    <a href="{{url('/setPrimaryAddress')}}{{$allData->user_id}}{{ $j }}" 
                                       class="link-primary" >Set as Default</a>
                                    <div class="mt-4 showHideEditForm">
                                       <form method="post" 
                                       action="{{url('/allAddressUpdate')}}">
                                       @csrf
                                            <input type="hidden" name="editAllAddId" value="{{$allData->user_id}}">
                                            <input type="hidden" name="addressIndex" value="{{$j}}">
                                            <input type="text" name="allAddress" value="{{$add}}">
                                            <button class="btn btn-primary">update</button>
                                        </form>
                                    </div>
                                    <div class="mt-4">
                                       <button  
                                        class="btn btn-outline-success addEditBtn">Edit</button>
                                       <!-- btn -->
                                       <a href="{{url('/allAddressDelete')}}{{$allData->user_id}}{{ $j }}"  
               ...
               <script src="/assets/js/vendors/address.js"></script>
 <!-- SSSSSSSSSSSSSSSSSSSSSSSSSSSS ADDRESS SECTION ENDING SSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSS -->  
               </div>
            </div>
         </section>
      </main>
<!-- SSSSSSSSSSSSSSSSSSSSSSSSSSSS HERO SECTION ENDING SSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSS -->
...
<!-- SSSSSSSSSSSSSSSSSSSSSSSSSSSS USER MODAL SSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSS -->
      ...
      <div class="modal-body">
       ...
       <img src="{{$allData->image}}" width="150" height="150" style="border-radius: 50%;margin-left:9rem;" >
       <h2 style="width: 40%;margin: auto;">{{$allData->name}}</h2>
        </div>
       <br>
 @if($allData->user_type == 'buyer')
...
<!-- SSSSSSSSSSSSSSSSSSSSSSSSSSSS DELETE MODAL SSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSS -->
...
<!-- SSSSSSSSSSSSSSSSSSSSSSSSSSSS DELETE MODAL ENDING SSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSS -->

<!-- SSSSSSSSSSSSSSSSSSSSSSSSSSSS NEW ADDRESS MODAL  SSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSS -->
      <!-- Modal -->
      <div class="modal fade" id="addAddressModal" tabindex="-1" aria-labelledby="addAddressModalLabel" aria-hidden="true">
         <div class="modal-dialog modal-dialog-centered">
            ...
            <div class="modal-content">
               ...
               <div class="modal-body p-6">
                  ...
                  <!-- row -->
                   <form method="post" action="{{url('/newAddressAdd')}}">
                    @csrf
                  <div class="row g-3">
                     <!-- col -->
                     <div class="col-12">
                        <!-- input -->
                         <input type="hidden" name="addressId" value="{{$allData->user_id}}">
                        <input type="text" name="address" class="form-control" placeholder="Address Line " /><br>
                     </div>
                     </div>
       ...
       @endif  
<!-- SSSSSSSSSSSSSSSSSSSSSSSSSSSS NEW ADDRESS MODAL ENDING SSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSS -->
      <!-- modal -->
